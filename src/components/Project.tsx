...
function Project() {
    ...
    <div className="projects-container" id="projects">
        ...
        <div className="projects-grid">
            ...
            <div className="project">
                <a href="https://www.linkedin.com/posts/khalil-ouald-chaib-4b4715312_ai-recruiting-chatbot-activity-7298256837584261120-NUcH?utm_source=share&utm_medium=member_desktop&rcm=ACoAAE976YgBS0gThs2DDxAuuEHXZV5pWkMQg5g" target="_blank" rel="noreferrer"><img src={mock05} className="zoom" alt="thumbnail" width="100%"/></a>
                <a href="https://www.linkedin.com/posts/khalil-ouald-chaib-4b4715312_ai-recruiting-chatbot-activity-7298256837584261120-NUcH?utm_source=share&utm_medium=member_desktop&rcm=ACoAAE976YgBS0gThs2DDxAuuEHXZV5pWkMQg5g" target="_blank" rel="noreferrer"><h2>Recruiting Chatbot</h2></a>
                <p>I created a recruiting chatbot using Botpress that helps users find job opportunities tailored to their profiles. Just enter your skills and experience, and the bot suggests relevant positions, and if you’re ready to apply, it can even apply for you automatically!</p>
            </div>
